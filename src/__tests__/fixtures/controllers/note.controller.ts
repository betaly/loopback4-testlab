...
import {NOTE_REPO_BINDING_KEY, NoteRepository} from '../repositories/note.repository';
...
export class NoteController {
  ...
  async count(@param.query.object('where', getWhereSchemaFor(Note)) where?: Where<Note>): Promise<Count> {
  ...
  async replaceById(@param.path.number('id') id: number, @requestBody() note: Note): Promise<void> {
